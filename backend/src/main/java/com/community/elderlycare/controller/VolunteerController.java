...
public class VolunteerController {
    ...
    @PostMapping
    public Volunteer create(@RequestBody Volunteer v) { return repo.save(v); }

    @PutMapping("/{id}")
    public void update(@PathVariable Long id, @RequestBody Volunteer v) { v.setId(id); repo.update(v); }
